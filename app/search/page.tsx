...
export const metadata: Metadata = { title: "Search", description: "Search GermanyBase's practical guides and tools.", alternates: { canonical: absoluteUrl("/search") }, robots: { index: false, follow: true } };
