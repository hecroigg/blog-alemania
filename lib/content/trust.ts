...
export const trustPages: TrustPage[] = [
  { slug: "about", title: "Clarity for building a life in Germany", eyebrow: "About us", description: "Living Germany is an independent editorial platform for people moving to Germany and the people already making a life here.", sections: [
  ...
  { slug: "editorial-policy", title: "Editorial policy", eyebrow: "Trust", description: "How we choose, structure, review, label, and update Living Germany content.", sections: [
  ...
  { slug: "corrections-policy", title: "Corrections policy", eyebrow: "Trust", description: "How to report an error and what we do when published information needs correction.", sections: [
    ...
    { heading: "Contact", paragraphs: ["Email hello@livinggermany.example with the subject ‘Correction’. The address is a project placeholder until the final domain and mailbox are connected." ] },
  ] },
  { slug: "affiliate-disclosure", title: "Affiliate disclosure", eyebrow: "Commercial transparency", description: "How future affiliate relationships will be labelled and separated from editorial judgement.", sections: [
    { heading: "No hidden recommendations", paragraphs: ["Living Germany currently does not publish active affiliate links. If that changes, links that may earn a commission will be identified near the recommendation and the page will include a disclosure." ] },
  ...
  { slug: "advertiser-disclosure", title: "Advertiser disclosure", eyebrow: "Commercial transparency", description: "The rules for advertising and sponsored content on Living Germany.", sections: [
  ...
  { slug: "privacy-policy", title: "Privacy policy", eyebrow: "Legal", description: "A plain-language launch-stage explanation of data handling on Living Germany.", sections: [
  ...
  { slug: "terms", title: "Terms of use", eyebrow: "Legal", description: "The baseline terms for using Living Germany's public information and tools.", sections: [
  ...
  { slug: "contact", title: "Contact Living Germany", eyebrow: "Contact", description: "Questions, corrections, and responsible commercial enquiries are welcome.", sections: [
    { heading: "Editorial questions and corrections", paragraphs: ["For a correction, include the page URL, the passage concerned, and an authoritative source where possible. Email hello@livinggermany.example with the subject ‘Correction’." ] },
