...
export const uiCopy: Record<Locale, {
  ...
  en: { search: "Search", language: "Language", menu: "Open menu", plan: "Plan your move", tools: "Tools", guides: "All guides", visa: "Visas & residence", cities: "Cities" },
  es: { search: "Buscar", language: "Idioma", menu: "Abrir menú", plan: "Planifica tu mudanza", tools: "Herramientas", guides: "Todas las guías", visa: "Visados y residencia", cities: "Ciudades" },
  de: { search: "Suchen", language: "Sprache", menu: "Menü öffnen", plan: "Umzug planen", tools: "Tools", guides: "Alle Ratgeber", visa: "Visa & Aufenthalt", cities: "Städte" },
  fr: { search: "Rechercher", language: "Langue", menu: "Ouvrir le menu", plan: "Planifier mon départ", tools: "Outils", guides: "Tous les guides", visa: "Visas et séjour", cities: "Villes" },
  it: { search: "Cerca", language: "Lingua", menu: "Apri menu", plan: "Pianifica il trasferimento", tools: "Strumenti", guides: "Tutte le guide", visa: "Visti e soggiorno", cities: "Città" },
  pt: { search: "Pesquisar", language: "Idioma", menu: "Abrir menu", plan: "Planeie a mudança", tools: "Ferramentas", guides: "Todos os guias", visa: "Vistos e residência", cities: "Cidades" },
  pl: { search: "Szukaj", language: "Język", menu: "Otwórz menu", plan: "Zaplanuj przeprowadzkę", tools: "Narzędzia", guides: "Wszystkie poradniki", visa: "Wizy i pobyt", cities: "Miasta" },
  uk: { search: "Пошук", language: "Мова", menu: "Відкрити меню", plan: "Спланувати переїзд", tools: "Інструменти", guides: "Усі матеріали", visa: "Візи та проживання", cities: "Міста" },
};
