...
export const trackedFacts: Record<string, TrackedFact> = {
  rundfunkbeitragMonthly: { key: "rundfunkbeitragMonthly", label: "Rundfunkbeitrag", value: 18.36, unit: "EUR per dwelling/month", geography: "Germany", source: "Federal service portal", sourceUrl: "https://verwaltung.bund.de/leistungsverzeichnis/DE/leistung/99107008104002", lastVerified: "2026-09-24", status: "verified", notes: "One contribution per dwelling in the standard case, regardless of how many people live there; exemptions and reductions must be checked separately." },
  deutschlandticketMonthly: { key: "deutschlandticketMonthly", label: "Deutschlandticket", value: 63, unit: "EUR per person/month", geography: "Germany", source: "Deutsche Bahn", sourceUrl: "https://www.bahn.de/faq/gk/angebot/zeitkarten/deutschland-ticket", lastVerified: "2026-09-24", status: "verified", notes: "Personal subscription for participating local and regional public transport; it is not normally valid on IC, EC or ICE services." },
  deutschlandSemesterTicketMonthly: { key: "deutschlandSemesterTicketMonthly", label: "Deutschlandsemesterticket", value: 37.8, unit: "EUR per eligible student/month", geography: "Participating German higher-education institutions", source: "German Federal Government", sourceUrl: "https://www.bundesregierung.de/breg-de/service/fragen-und-anworten/deutschlandticket-2134074", lastVerified: "2026-09-24", status: "route-specific", notes: "The nationwide semester ticket is priced at 60% of the Deutschlandticket: EUR 226.80 per six-month semester from winter semester 2026/27. Participation and eligibility depend on the institution." },
  bahnCard25Annual: { key: "bahnCard25Annual", label: "BahnCard 25, second class", value: 62.9, unit: "EUR/year", geography: "Germany", source: "Deutsche Bahn", sourceUrl: "https://int.bahn.de/en/offers/bahncard", lastVerified: "2026-09-24", status: "verified", notes: "Standard annual price; it gives 25% off eligible flexible and saver fares. Promotional prices are excluded." },
  bahnCard50Annual: { key: "bahnCard50Annual", label: "BahnCard 50, second class", value: 244, unit: "EUR/year", geography: "Germany", source: "Deutsche Bahn", sourceUrl: "https://int.bahn.de/en/offers/bahncard", lastVerified: "2026-09-24", status: "verified", notes: "Standard annual price; check Deutsche Bahn's fare conditions and automatic-renewal rules before purchase." },
  bahnCard100Annual: { key: "bahnCard100Annual", label: "BahnCard 100, second class", value: 4899, unit: "EUR/year", geography: "Germany", source: "Deutsche Bahn", sourceUrl: "https://www.bahn.de/faq/pk/angebot/bahncard", lastVerified: "2026-09-24", status: "verified", notes: "Standard annual second-class price. The card is valid for one year and does not automatically renew; check the precise scope before purchase." },
  myBahnCard25Annual: { key: "myBahnCard25Annual", label: "My BahnCard 25, second class", value: 39.9, unit: "EUR/year for travellers under 27", geography: "Germany", source: "Deutsche Bahn", sourceUrl: "https://int.bahn.de/en/faq/how-much-does-a-my-bahncard-cost", lastVerified: "2026-09-24", status: "route-specific", notes: "Age eligibility applies. This is the standard My BahnCard 25 second-class price, excluding temporary promotions." },
  anmeldungDeadline: { key: "anmeldungDeadline", label: "Anmeldung deadline", value: 14, unit: "days after moving in", geography: "Germany", source: "Federal Registration Act §17", sourceUrl: "https://www.gesetze-im-internet.de/bmg/__17.html", lastVerified: "2026-09-24", status: "verified", notes: "The standard rule is registration within two weeks after moving into a dwelling. Statutory exceptions in §27 apply to certain temporary stays." },
  anmeldungFee: { key: "anmeldungFee", label: "Anmeldung fee", value: 0, unit: "EUR", geography: "Germany", source: "Federal service portal", sourceUrl: "https://verwaltung.bund.de/leistungsverzeichnis/DE/leistung/99115005104000", lastVerified: "2026-09-24", status: "verified", notes: "The standard address-registration service is free. Optional certificates or other municipal services can have separate fees." },
  nationalVisaStandardFee: { key: "nationalVisaStandardFee", label: "Standard national visa fee", value: 75, unit: "EUR", geography: "Germany", source: "Make it in Germany", sourceUrl: "https://www.make-it-in-germany.com/en/visa-residence/apply-for-visa", lastVerified: "2026-09-24", status: "route-specific", notes: "This is the standard long-stay visa fee. Exemptions, reductions and special cases exist; confirm with the responsible German mission." },
  firstResidencePermitMaximum: { key: "firstResidencePermitMaximum", label: "First residence permit / EU Blue Card", value: 100, unit: "EUR maximum standard fee", geography: "Germany", source: "Make it in Germany", sourceUrl: "https://www.make-it-in-germany.com/en/visa-residence/procedure/application-forms/print", lastVerified: "2026-09-24", status: "route-specific", notes: "The official guidance states a maximum of EUR 100; the applicable fee and exemptions depend on the case." },
  incomeTaxBasicAllowance: { key: "incomeTaxBasicAllowance", label: "Income-tax basic allowance", value: 12348, unit: "EUR taxable income/year", geography: "Germany · 2026", source: "Federal Ministry of Finance", sourceUrl: "https://ksth.bundesfinanzministerium.de/lsth/2026/A-Einkommensteuergesetz/IV-Tarif-31-34b/Paragraf-32a/inhalt.html", lastVerified: "2026-09-24", status: "verified", notes: "Income tax is EUR 0 up to this taxable-income amount for a single assessment. Gross salary is not the same as taxable income." },
  vatStandardRate: { key: "vatStandardRate", label: "Standard VAT rate", value: 19, unit: "%", geography: "Germany", source: "VAT Act §12", sourceUrl: "https://www.gesetze-im-internet.de/ustg_1980/__12.html", lastVerified: "2026-09-24", status: "verified", notes: "A reduced 7% rate applies only to legally specified supplies; exemptions and special rules also exist." },
  vatReducedRate: { key: "vatReducedRate", label: "Reduced VAT rate", value: 7, unit: "%", geography: "Germany", source: "VAT Act §12", sourceUrl: "https://www.gesetze-im-internet.de/ustg_1980/__12.html", lastVerified: "2026-09-24", status: "route-specific", notes: "This rate applies only to supplies listed by law. It is not a general discount for essential spending." },
  statutoryHealthBaseRate: { key: "statutoryHealthBaseRate", label: "Statutory health-insurance general rate", value: 14.6, unit: "% of contributory income", geography: "Germany · 2026", source: "Federal Ministry of Health", sourceUrl: "https://www.bundesgesundheitsministerium.de/beitraege/seite", lastVerified: "2026-09-24", status: "route-specific", notes: "An insurer-specific additional contribution applies; the official average for 2026 is 2.9%. Employment status and the contribution ceiling affect the actual amount." },
  healthAverageAdditionalRate: { key: "healthAverageAdditionalRate", label: "Average additional health-insurance rate", value: 2.9, unit: "% of contributory income", geography: "Germany · 2026", source: "Federal Ministry of Health", sourceUrl: "https://www.bundesgesundheitsministerium.de/beitraege/seite", lastVerified: "2026-09-24", status: "route-specific", notes: "This is the official 2026 average used for planning. Your health fund sets its own actual additional contribution rate." },
  longTermCareBaseRate: { key: "longTermCareBaseRate", label: "Long-term care insurance base rate", value: 3.6, unit: "% of contributory income", geography: "Germany · 2026", source: "Federal Ministry of Health", sourceUrl: "https://www.bundesgesundheitsministerium.de/themen/pflege/online-ratgeber-pflege/die-pflegeversicherung/finanzierung", lastVerified: "2026-09-24", status: "route-specific", notes: "The childless rate is 4.2%. Reductions based on the number of children and a separate Saxony split can apply." },
  pensionInsuranceRate: { key: "pensionInsuranceRate", label: "Statutory pension-insurance rate", value: 18.6, unit: "% of contributory income", geography: "Germany · 2026", source: "Federal Ministry of Labour and Social Affairs", sourceUrl: "https://www.bmas.de/DE/Soziales/Rente-und-Altersvorsorge/Gesetzliche-Rentenversicherung/Rentenberechnung/beitragssatz-in-der-gesetzlichen-rentenversicherung.html", lastVerified: "2026-09-24", status: "route-specific", notes: "For standard employees, the contribution is generally shared equally with the employer up to the contribution ceiling." },
  unemploymentInsuranceRate: { key: "unemploymentInsuranceRate", label: "Unemployment-insurance rate", value: 2.6, unit: "% of contributory income", geography: "Germany · 2026", source: "Federal Ministry of Labour and Social Affairs", sourceUrl: "https://www.bmas.de/DE/Service/Presse/Pressemitteilungen/2025/das-aendert-sich-im-neuen-jahr.html", lastVerified: "2026-09-24", status: "route-specific", notes: "For standard employees, the contribution is generally shared equally with the employer up to the contribution ceiling." },
  minimumWageHourly: { key: "minimumWageHourly", label: "Statutory minimum wage", value: 13.9, unit: "EUR gross/hour", geography: "Germany · from 1 January 2026", source: "Federal Ministry of Labour and Social Affairs", sourceUrl: "https://www.bmas.de/DE/Arbeit/Arbeitsrecht/Mindestlohn/mindestlohn.html", lastVerified: "2026-09-24", status: "verified", notes: "Exceptions defined by law can apply. This is the nationwide statutory rate from 1 January 2026." },
  minijobMonthlyLimit: { key: "minijobMonthlyLimit", label: "Minijob monthly earnings limit", value: 603, unit: "EUR/month on average", geography: "Germany · 2026", source: "German Federal Government", sourceUrl: "https://www.bundesregierung.de/breg-de/aktuelles/gesetzliche-neuregelungen-januar-2026-2399838", lastVerified: "2026-09-24", status: "verified", notes: "The limit follows the statutory minimum wage and applies as an average monthly earnings limit under the relevant rules." },
  childBenefitMonthly: { key: "childBenefitMonthly", label: "Kindergeld", value: 259, unit: "EUR per eligible child/month", geography: "Germany · 2026", source: "Federal Ministry of Finance", sourceUrl: "https://ksth.bundesfinanzministerium.de/lsth/2026/A-Einkommensteuergesetz/X-Kindergeld-62-78/Paragraf-66/inhalt.html", lastVerified: "2026-09-24", status: "route-specific", notes: "The amount is exact, but entitlement depends on the statutory eligibility requirements." },
