...
export type CategoryCardData = Pick<Category, "slug" | "name" | "description" | "icon" | "color">;
export type GuideCardData = Pick<Guide, "slug" | "eyebrow" | "readingMinutes" | "title" | "description">;
export type CityCardData = Pick<City, "slug" | "name" | "region" | "description" | "bestFor">;
...
export function GuideCard({ guide, compact = false }: { guide: GuideCardData; compact?: boolean }) {
